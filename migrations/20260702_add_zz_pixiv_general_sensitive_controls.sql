ALTER TABLE guild_provider_settings
    ADD COLUMN pixiv_sensitive_display_mode VARCHAR(32) NULL AFTER pixiv_tag_limit;

ALTER TABLE guild_provider_settings
    ADD COLUMN pixiv_sensitive_non_nsfw_channel_sensitive_restriction_enabled TINYINT(1) NULL AFTER pixiv_r18g_display_mode;

CREATE TABLE IF NOT EXISTS guild_provider_pixiv_sensitive_content_allowed_targets (
...
CREATE TABLE IF NOT EXISTS guild_provider_pixiv_sensitive_content_excluded_targets (
    provider_id VARCHAR(64) NOT NULL,
    guild_id VARCHAR(32) NOT NULL,
    target_type ENUM('user', 'channel', 'role') NOT NULL,
    target_id VARCHAR(32) NOT NULL,
