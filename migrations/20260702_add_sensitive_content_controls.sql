ALTER TABLE guild_provider_settings
    ADD COLUMN non_nsfw_channel_sensitive_restriction_enabled TINYINT(1) NULL AFTER quote_repost_depth_by_account;
...
ALTER TABLE guild_provider_settings
    ADD COLUMN pixiv_r18_non_nsfw_channel_sensitive_restriction_enabled TINYINT(1) NULL AFTER pixiv_r18g_display_mode;

ALTER TABLE guild_provider_settings
    ADD COLUMN pixiv_r18g_non_nsfw_channel_sensitive_restriction_enabled TINYINT(1) NULL AFTER pixiv_r18_non_nsfw_channel_sensitive_restriction_enabled;
...
CREATE TABLE IF NOT EXISTS guild_provider_pixiv_r18_sensitive_content_allowed_targets (
    provider_id VARCHAR(64) NOT NULL,
    guild_id VARCHAR(32) NOT NULL,
    target_type ENUM('user', 'channel', 'role') NOT NULL,
    target_id VARCHAR(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS guild_provider_pixiv_r18_sensitive_content_excluded_targets (
    provider_id VARCHAR(64) NOT NULL,
    guild_id VARCHAR(32) NOT NULL,
    target_type ENUM('user', 'channel', 'role') NOT NULL,
    target_id VARCHAR(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS guild_provider_pixiv_r18g_sensitive_content_allowed_targets (
    provider_id VARCHAR(64) NOT NULL,
    guild_id VARCHAR(32) NOT NULL,
    target_type ENUM('user', 'channel', 'role') NOT NULL,
    target_id VARCHAR(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS guild_provider_pixiv_r18g_sensitive_content_excluded_targets (
    provider_id VARCHAR(64) NOT NULL,
    guild_id VARCHAR(32) NOT NULL,
    target_type ENUM('user', 'channel', 'role') NOT NULL,
    target_id VARCHAR(32) NOT NULL,
