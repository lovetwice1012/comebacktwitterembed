    ...
    */
    ...
    for (let guildId in new_settings) {
        connection.query(
            ...
            [guildId, new_settings[guildId]['bannedWords'], new_settings[guildId]['defaultLanguage'], new_settings[guildId]['editOriginalIfTranslate'], new_settings[guildId]['sendMediaAsAttachmentsAsDefault'], new_settings[guildId]['deleteMessageIfOnlyPostedTweetLink'], new_settings[guildId]['alwaysReply'], new_settings[guildId]['button_invisible_showMediaAsAttachments'], new_settings[guildId]['button_invisible_showAttachmentsAsEmbedsImage'], new_settings[guildId]['button_invisible_translate'], new_settings[guildId]['button_invisible_delete'], new_settings[guildId]['button_invisible_reload'], new_settings[guildId]['button_disabled_users'], new_settings[guildId]['button_disabled_channels'], new_settings[guildId]['button_disabled_roles'], new_settings[guildId]['extractBotMessage'], new_settings[guildId]['maxExtractQuotedTweet']],
            (error, results) => {
                if (error) {
                    console.error(error);
                    return;
