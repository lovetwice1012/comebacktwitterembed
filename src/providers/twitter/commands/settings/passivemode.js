...
module.exports = async function (interaction, client) {
    ...
    await setSetting({ id: 'twitter' }, 'passive_mode', interaction.guildId, boolean);
    await interaction.editReply((t('setpassivemodetolocales', interaction.locale)) + convertBoolToEnableDisable(boolean, interaction.locale));
